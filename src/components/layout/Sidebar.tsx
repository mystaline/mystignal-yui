...
import { LayoutDashboard, BookOpen, History, Zap, CandlestickChart } from 'lucide-react'

const NAV_ITEMS = [
  { to: '/',          label: 'Dashboard', icon: LayoutDashboard, end: true },
  { to: '/trade',     label: 'Trade',     icon: BookOpen },
  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-6 hidden md:block" style={{ marginBottom: 4 }}>
        <div className="display" style={{ fontSize: 22, letterSpacing: '-0.01em', lineHeight: 1 }}>
          Mystignal
      ...
      <div className="px-2 py-4 block md:hidden">
        <div className="w-8 h-8 rounded-md flex items-center justify-center"
          ...
          <span className="mono font-black text-xs" style={{ color: 'var(--accent-ink)' }}>M</span>
        </div>
      </div>
      ...
      {/* Footer */}
      <div className="px-2 md:px-3 pb-4 pt-2" style={{ borderTop: '1px solid var(--line)' }}>
        <p className="hidden md:block mono text-center pt-2"
